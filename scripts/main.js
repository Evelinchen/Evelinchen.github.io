;(function (window) {
  ...
  let texts = ['忙了一天','辛苦~log','但是钱多多了哈','给你一个','儿童节的','睡前故事吧',
  '小兔子的妈妈','有一家','糖果屋','小老虎有一个','冰激凌机。','兔妈告诉小兔子','如果你喜欢','一个人~',
  '就给他一颗糖','小白兔喜欢上了','小老虎','特别特别喜欢','忍不住就把','整个店给小老虎','回到家后','兔妈就问','aiya','今天有点晚了','haha明天接着~','晚安~~']
